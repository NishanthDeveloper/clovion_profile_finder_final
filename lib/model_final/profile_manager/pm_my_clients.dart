...
//
//     final pmMyClientsModel = pmMyClientsModelFromJson(jsonString);

import 'dart:convert';

List<PmMyClientsModel> pmMyClientsModelFromJson(String str) => List<PmMyClientsModel>.from(json.decode(str).map((x) => PmMyClientsModel.fromJson(x)));

// String pmMyClientsModelToJson(List<PmMyClientsModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
String pmMyClientsModelToJson(List<PmMyClientsModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));




class PmMyClientsModel {
    int? id;
    String? uid;
    String? email;
    String? mobile;
    ...
    factory PmMyClientsModel.fromJson(Map<String, dynamic> json) => PmMyClientsModel(
        id: json["id"],
        uid: json["uid"],
        email: json["email"],
        mobile: json["mobile"],
