...
//
//     final pmMyClients = pmMyClientsFromJson(jsonString);

import 'dart:convert';

PmMyClients pmMyClientsFromJson(String str) => PmMyClients.fromJson(json.decode(str));

String pmMyClientsToJson(PmMyClients data) => json.encode(data.toJson());

class PmMyClients {
    List<The42284Ohjsh7>? the42284Ohjsh7;

    PmMyClients({
        this.the42284Ohjsh7,
    });

    factory PmMyClients.fromJson(Map<String, dynamic> json) => PmMyClients(
        the42284Ohjsh7: json["42284OHJSH7"] == null ? [] : List<The42284Ohjsh7>.from(json["42284OHJSH7"]!.map((x) => The42284Ohjsh7.fromJson(x))),
    );

    Map<String, dynamic> toJson() => {
        "42284OHJSH7": the42284Ohjsh7 == null ? [] : List<dynamic>.from(the42284Ohjsh7!.map((x) => x.toJson())),
    };
}

class The42284Ohjsh7 {
    int? id;
    String? uid;
    String? email;
    String? mobile;
    ...
    factory The42284Ohjsh7.fromJson(Map<String, dynamic> json) => The42284Ohjsh7(
        id: json["id"],
        uid: json["uid"],
        email: json["email"],
        mobile: json["mobile"],
