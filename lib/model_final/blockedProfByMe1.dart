...
// String blockedProfilesByMe1ToJson(BlockedProfilesByMe1 data) => json.encode(data.toJson());

class BlockedProfilesByMe1 {
    List<MyProf> myProf;

    BlockedProfilesByMe1({
        required this.myProf,
    });

    factory BlockedProfilesByMe1.fromJson(Map<String, dynamic> json, String uid) => BlockedProfilesByMe1(
        myProf: json[uid] == null ? [] : List<MyProf>.from(json[uid]!.map((x) => MyProf.fromJson(x))),
    );

    Map<String, dynamic> toJson(String uid) => {
        uid: myProf == null ? [] : List<dynamic>.from(myProf!.map((x) => x.toJson())),
    };
}
...
class MyProf {
    ...
    factory MyProf.fromJson(Map<String, dynamic> json) => MyProf(
        id: json["id"],
        uid: json["uid"],
        email: json["email"],
        mobile: json["mobile"],
