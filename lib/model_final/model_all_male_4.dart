...
//
//     final allMaleUserData4 = allMaleUserData4FromJson(jsonString);

import 'dart:convert';


AllMaleUserData4 allMaleUserData4FromJson(String str) => AllMaleUserData4.fromJson(json.decode(str));

String allMaleUserData4ToJson(AllMaleUserData4 data) => json.encode(data.toJson());

class AllMaleUserData4  {
  String? userUid;
    ...
    factory AllMaleUserData4.fromJson(Map<String, dynamic> json) => AllMaleUserData4(
        the0Ppqmbpewtl: json["3PEZ9RJZRKZ"] == null ? [] : List<The0Ppqmbpewtl>.from(json["3PEZ9RJZRKZ"]!.map((x) => The0Ppqmbpewtl.fromJson(x))),
    );

    Map<String, dynamic> toJson() => {
        "3PEZ9RJZRKZ": the0Ppqmbpewtl == null ? [] : List<dynamic>.from(the0Ppqmbpewtl!.map((x) => x.toJson())),
    };

    // factory AllMaleUserData4.fromJson(Map<String, dynamic> json) => AllMaleUserData4(
    //     the0Ppqmbpewtl: json["3PEZ9RJZRKZA"] == null ? [] : List<The0Ppqmbpewtl>.from(json["3PEZ9RJZRKZA"]!.map((x) => The0Ppqmbpewtl.fromJson(x))), userUid: ThreeSigninScreen.userUidAccess,
    // );

    // Map<String, dynamic> toJson() => {
    //     "3PEZ9RJZRKZA": the0Ppqmbpewtl == null ? [] : List<dynamic>.from(the0Ppqmbpewtl!.map((x) => x.toJson())),
    // };
}
...
class The0Ppqmbpewtl {
    ...
    The0Ppqmbpewtl({
        ...
        this.primaryCountry,
        this.selfie = 'https://1.bp.blogspot.com/-haINpdcuYbE/YV1JNgW5hOI/AAAAAAAAAjg/ZRLda10em3MJKiUFS9dyHntNRistS3QIACNcBGAsYHQ/s930/EZ-Gui_no_data_received.jpg' ,
        this.fullSizeImage,
        this.familyImage,
        this.gallery,
        this.horoscope,
