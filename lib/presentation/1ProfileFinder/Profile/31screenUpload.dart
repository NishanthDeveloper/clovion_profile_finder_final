// Widget Screen. This page not used as screen
...
class UploadThirtyOneScreen extends StatefulWidget {
  final String? userId;

  const UploadThirtyOneScreen({super.key, this.userId});

  @override
  State<UploadThirtyOneScreen> createState() => _UploadThirtyOneScreenState();
}

class _UploadThirtyOneScreenState extends State<UploadThirtyOneScreen> {
  File? _image;
