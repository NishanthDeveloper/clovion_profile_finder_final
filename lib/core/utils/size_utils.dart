...
class DeviceSize {
   ...
   static double DeviceHeight = MediaQuery.of(context as BuildContext).size.height;
  static double DeviceWidth = MediaQuery.of(context as BuildContext).size.width;
   static double screenHeight = (size.height - kToolbarHeight - 24);
  static double itemHeight = (size.height - kToolbarHeight - 24) / 4;
